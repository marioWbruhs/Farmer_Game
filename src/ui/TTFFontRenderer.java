//ALL CREDITS GO TO 187QRLY.
//follow him on github at 187qrly
package ui;
...
public class TTFFontRenderer {
    ...
    private CharacterData[] setup(final CharacterData[] characterData, final int type) {
        ...
        for (int index = 0; index < characterData.length; ++index) {
            ...
            final BufferedImage characterImage = new BufferedImage(this.ceiling_double_int(width),
                    this.ceiling_double_int(height), 2);
